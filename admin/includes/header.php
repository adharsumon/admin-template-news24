...
<head>
  ...
  <title>News24 Admin Dashboard </title>
  <!-- plugins:css -->
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Good Morning, <span class="text-black fw-bold" style="text-transform: capitalize;"><?php echo $_SESSION['u_name']; ?></span></h1>
